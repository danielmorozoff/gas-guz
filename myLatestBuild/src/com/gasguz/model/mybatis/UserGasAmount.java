...
public class UserGasAmount extends AbstractForm {
  private static final long serialVersionUID = 1L;
     ...
     * This field corresponds to the database column GG_USER_GAS_AMOUNT.ID
     *
     * @mbggenerated
     */
    private Long id;
     ...
     * This method returns the value of the database column GG_USER_GAS_AMOUNT.ID
     *
     * @return the value of GG_USER_GAS_AMOUNT.ID
     *
     * @mbggenerated
     */
    public Long getId() {
    ...
    /**
     * This method was generated by MyBatis Generator.
     * This method sets the value of the database column GG_USER_GAS_AMOUNT.ID
     *
     * @param id the value for GG_USER_GAS_AMOUNT.ID
     *
     * @mbggenerated
     */
