...
public class GeneralController extends Controller {
  ...
  //Page Template Rendering
    public static void dashboardPg(String pubId){
    	//System.out.println("Rendering page for  USER: "+user.userName +" with pUID: "+user.publicId);
    	renderTemplate("app/views/Application/Dashboard/page1.html",pubId);
    }
